...
import { User, MapPin, Mail, Phone, Plus, X, Building, Globe } from 'lucide-react';
            ...
            <div className="space-y-4">
              ...
              <div>
                <Label htmlFor="addressLine1" className="text-sm font-medium text-gray-700 flex items-center">
                  <Building className="mr-2 h-4 w-4 text-blue-500" /> Address Line 1
                </Label>
                <Input 
                  id="addressLine1" 
                  name="addressLine1" 
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <Label htmlFor="addressZipCode" className="text-sm font-medium text-gray-700">Zip Code</Label>
                  <Input 
                    id="addressZipCode" 
                    name="addressZipCode" 
              ...
              <div>
                <Label htmlFor="addressCountry" className="text-sm font-medium text-gray-700 flex items-center">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                {employee.contactMethods.map((contact, index) => (
                  <div key={index} className="flex items-center bg-gray-50 p-3 rounded-md transition-all duration-300 hover:shadow-md">
                    {contact.contactMethod === 'EMAIL' ? <Mail className="mr-3 text-blue-500 h-4 w-4" /> : <Phone className="mr-3 text-green-500 h-4 w-4" />}
              ...
              <div className="flex space-x-2">
                <Select onValueChange={(value) => handleContactChange('contactMethod', value)}>
